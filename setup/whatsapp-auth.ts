...
<html><head><title>Deus - WhatsApp Auth</title>
...
<html><head><title>Deus - Connected!</title>
<style>
...
<script>localStorage.removeItem('deus_qr_start');</script>
</body></html>`;
