...
| **ui-copy-writer** | Validator | Sonnet | `ui-copy-rules.md` | Manual: invoke after changes that add or modify user-facing strings, error messages, help text, or status indicators |
